...
const FormContainer: React.FunctionComponent<IFormContainerProps> = (props) => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    try {
      await axios.post(`${serverUrl}/shortUrl`, { fullUrl: fullUrl }); // Change to HTTP
      ...
      <div className="bg-banner my-8 rounded-xl bg-cover bg-center">
        <div className="w-full h-full rounded-xl p-20 backdrop-brightness-50">
          ...
          <p className="text-white text-center pb-4 text-sm font-thin">
            Free tool to shorten a URL or reduce link,Use our URL Shotener to
            ...
            <div className="flex">
              <div className="relative w-full">
                ...
                <input
                  ...
                  required
                  className="block w-full  p-4 ps-40 text-sm text-gray-900 border border-gray-300 rounded-lg bg-white focus:ring-blue-500 focus:border-bl-500"
                  value={fullUrl}
